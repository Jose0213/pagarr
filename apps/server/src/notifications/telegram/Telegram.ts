...
/** Ported from NzbDrone.Core/Notifications/Telegram/Telegram.cs. */
export class Telegram extends NotificationBase<TelegramSettings> {
  private readonly proxy: ITelegramProxy;

  readonly name = "Telegram";
  readonly configContract = "TelegramSettings";
  readonly link = "https://telegram.org/";

  constructor(proxy: ITelegramProxy) {
    super();
    this.proxy = proxy;
  }
