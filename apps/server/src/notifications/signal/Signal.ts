...
/** Ported from NzbDrone.Core/Notifications/Signal/Signal.cs. */
export class Signal extends NotificationBase<SignalSettings> {
  private readonly proxy: ISignalProxy;

  readonly name = "Signal";
  readonly configContract = "SignalSettings";
  readonly link = "https://signal.org/";

  constructor(proxy: ISignalProxy) {
    super();
    this.proxy = proxy;
  }
